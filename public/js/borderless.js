...
!(function(s) {
    ...
    Waves.init({ duration: 300 }),
        ...
        s("[data-backround-image]").each(function(e) {
            s(this).css(
                "background",
                "url(" + s(this).data("backround-image") + ")"
            );
        }),
        n.on("load", function() {
                ...
                s(".side-menu .side-menu-body ul li a").each(function() {
                    ...
                    e.next("ul").length &&
                        (o.hasClass("horizontal-side-menu")
                            ? (e.append(
                                  '<i class="sub-menu-arrow lni-chevron-right"></i>'
                              ),
                              s(
                                  ".side-menu .side-menu-body > ul > li > a > .sub-menu-arrow"
                              )
                                  .removeClass("lni-chevron-right")
                                  .addClass("lni-chevron-down"))
                            : e.append(
                                  '<i class="sub-menu-arrow lni-plus"></i>'
                              ));
                }),
        ...
        s(document).on("click", "*", function(e) {
            ((!s(e.target).is(
                ...
                (!s(e.target).is(
                    ...
                    s("nav.navbar .header-body form.search").hasClass(
                        "show"
                    )) ||
                (!s(e.target).is(
              ...
              768 <= n.width() &&
                  ...
                  s(".chat-app .chat-body .chat-body-messages")[0] &&
                      s(".chat-app .chat-body .chat-body-messages")
                          ...
                          .resize()))
            : (768 <= n.width() &&
                  (s(".card-scroll").niceScroll(),
                  s(".table-responsive").niceScroll()),
              ((!o.hasClass("horizontal-side-menu") && 992 <= n.width()) ||
                  (o.hasClass("horizontal-side-menu") && n.width() < 992)) &&
                  n.on("load", function() {
                      !o.hasClass("horizontal-side-menu") &&
              ...
              768 <= n.width() &&
                  (s(".chat-app .chat-sidebar .chat-sidebar-messages")[0] &&
                      s(".chat-app .chat-sidebar .chat-sidebar-messages")
                          .scrollTop(
                              s(
                                  ".chat-app .chat-sidebar .chat-sidebar-messages"
                              ).get(0).scrollHeight,
                              -1
                          )
                          .niceScroll(),
                  s(".chat-app .chat-body .chat-body-messages")[0] &&
                      s(".chat-app .chat-body .chat-body-messages")
                          .scrollTop(
                              s(".chat-app .chat-body .chat-body-messages").get(
                                  0
                              ).scrollHeight,
                              -1
                          )
    ...
    if (
        ...
        s(document).on(
            ...
            function() {
                return (
                    s(".chat-app-wrapper .chat-sidebar").addClass(
                        "chat-sidebar-opened"
                    ),
                    !1
                );
        ...
        s(document).on("click", "*", function(e) {
            s(e.target).is(
                ...
                s(".chat-app-wrapper .chat-sidebar").removeClass(
                    "chat-sidebar-opened"
                );
        }),
            ...
            if (e.next("ul").length) {
                ...
                return (
                    ...
                    a.hasClass("rotate-in")
                        ? setTimeout(function() {
                              a.removeClass("lni-plus").addClass("lni-minus");
                          }, 200)
                        : a.removeClass("lni-minus").addClass("lni-plus"),
                    !o.hasClass("horizontal-side-menu") &&
                        768 <= n.width() &&
